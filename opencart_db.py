...
class OrderStatus(IntEnum):
    ...
    FAILED = 10
    PAID_WILL_SHIP = 2
    PAID_ADDRESS_VALIDATION_FAILED = 18
    PAID_SENT_TO_WAREPAK = 15
    PAID_SHIPPED = 3
    PAID_VALIDATED_WILL_SHIP = 17
    REFUNDED = 11
    REVERSED = 12
    UNPAID_WILL_NOT_SHIP = 1
    UNPAID_SENT_TO_WAREPAK = 20
    UNPAID_SHIPPED = 19
    UNPAID_VALIDATED_WILL_SHIP = 22
    UNPAID_VALIDATION_FAILED = 23
    UNPAID_WILL_SHIP = 21
    VOIDED = 16
